...
class SecondNotificationService: Service() {
    ...
    override fun onCreate() {
        ...
        val handlerThread = HandlerThread("ThirdThread") // UBAH: Nama thread
            .apply { start() }
    ...
    private fun startForegroundService(): NotificationCompat.Builder {
        ...
        startForeground(NOTIFICATION_ID, notificationBuilder.build()) // UBAH: Gunakan NOTIFICATION_ID baru
